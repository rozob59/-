        ...
        <div id="issueBookModal" class="hidden fixed inset-0 z-[200] bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4">
            <div class="glass-panel w-full max-w-md p-8 rounded-[2.5rem] relative">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-teal-400 uppercase mb-2 ml-1">ফেরত দেওয়ার তারিখ</label>
                        <input type="date" id="issueReturnDate" class="w-full bg-slate-900 border border-white/10 rounded-2xl py-3.5 px-4 focus:outline-none text-white appearance-none">
                    </div>
...
<script>
    ...
    <script type="module">
        ...
        function openIssueBookModal() {
            ...
            const returnDateInput = document.getElementById('issueReturnDate');
        ...
        async function confirmIssueBook() {
            ...
            if(!returnDateStr) return showToast("ফেরত দেওয়ার তারিখ নির্বাচন করুন", "error");
